                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-block btn-danger btn-xs" onclick="window.location.href='markinactive.php?id=<?php echo $row['id']; ?>'">Mark as Inactive</button></td>
                    </tr>
                    <?php
                    $c ++;
                    } ?>
